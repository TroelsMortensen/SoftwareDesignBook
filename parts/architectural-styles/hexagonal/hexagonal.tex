...
In this diagram, Figure~\ref{fig:hex_class_diagram}, the arrows are more explicit. But still, between packages,  they point the same direction as the previous package diagram in Figure~\ref{fig:hex_package_diagram}.
...
First, I model the domain classes. To keep things short and simple, I will do this with records. The result is that the domain classes are very simple, just data, and contains no behavior or logic.
