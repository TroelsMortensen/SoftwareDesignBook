...
\end{ridercode}
\captionof{listing}{\texttt{ConfirmKaijuDetectionPort} input port}
...
Code snippet~\ref{lst:kaiju-controller} shows a driving adapter that talks only to the input port and maps transport-specific models to use-case models:
...
\end{ridercode}
\captionof{listing}{\texttt{LoadBreachPort} output port}
