...
.2 \foldericon\ application/.
.3 \foldericon\ inboundports/.
.4 \fileicon\ TriangulateKaijuPositionUseCase.java.
.3 \foldericon\ outboundports/.
.4 \foldericon\ repositories/.
...
.2 \foldericon\ outboundadapters/.
.3 \foldericon\ persistence/.
.4 \fileicon\ JpaSensorRepositoryAdapter.java.
.3 \foldericon\ sensordrivers/.
.4 \fileicon\ AcousticSensorDriverAdapter.java.
.4 \fileicon\ RadiationSensorDriverAdapter.java.
.4 \fileicon\ SeismicSensorDriverAdapter.java.
.4 \fileicon\ SensorDriverFactoryAdapter.java.
.4 \fileicon\ ThermalSensorDriverAdapter.java.
}
\end{minipage}
\end{figure}
