...
\begin{figure}[h]
\centering
\begin{minipage}{0.8\textwidth} % Keeps the lines tight
\scriptsize % Shrinks font and icons globally
\setlength{\DTbaselineskip}{10pt}
\DTsetlength{0.2em}{0.8em}{0.2em}{0.4pt}{1.6pt}       % Tightens horizontal indentation
\dirtree{%
.1 \foldericon\ src/.
.2 \foldericon\ application/.
.3 \foldericon\ inboundports/.
