...
\begin{itemize}
    \item test application behavior through input ports without real infrastructure (i.e. replace driven adapters with test doubles),
...
In Java, we can keep most behavior tests focused on the core. Code snippet~\ref{lst:confirm-detection-test} shows an example of testing a use case defined in a service class. We use a fake implementation of the repository and the event publisher. Both fakes implement the the necessary interface.
