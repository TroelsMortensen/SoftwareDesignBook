...
\begin{tikzpicture}[
    ...
    % 2. PORTS
    \node[port_box, anchor=north west] (in_port) at (app_core.north west) {Inbound Ports};
    \node[port_box, anchor=north east] (out_port) at (app_core.north east) {Outbound Ports};
